<html>
    <head>
        ...
        <link rel="stylesheet" href="Styling Sheet Form.css">
        ...
        <div class="container">
            <div class="navbar">
                ...
                <nav>
                    <ul id="menuList">
                        ...
                        <li><a class="active"href="PHP Confirm.php">Confirmation Mail</a></li>
                        <li><a href="PHP booking details.php">Booking details</a>
            ...
            <?php
                    ...
                    if(isset($_POST['send'])){
                       ...
                       $sender = "From: serenebeauty@gmail.com";
